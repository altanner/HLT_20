...
namespace KalmanFilter
{
    ...
    smoothingState(Graph &graph,
                   const Tensor &states,
                   const Tensor &itr,
                   uint tile);

    std::tuple<ComputeSet, Tensor>
    appendTo(Graph &graph,
             const Tensor &state,
             const Tensor &itr,
             Tensor &states,
             uint tile);
    ...
    std::tuple<Sequence, std::vector<Tensor>>
    packIterationTensors(Graph &graph,
